...
public class SwitchingController {
    ...
    public  void switchToSignup(ActionEvent event) throws IOException {
        ...
        Button button = (Button) root.lookup("#sumbitAdmin"); button.setVisible(false);
        button = (Button) root.lookup("#sumbit"); button.setVisible(true);
    ...
    public  void switchToModify(ActionEvent event) throws IOException {
        ...
        Button button = (Button) root.lookup("#sumbitAdmin"); button.setVisible(true);
        button = (Button) root.lookup("#sumbit"); button.setVisible(false);
        stage.setWidth(625);stage.setHeight(525);
        stage.setScene(scene);
        stage.show();
    }
    ...
    public void switchToHome(ActionEvent event) throws IOException {
        scene = getScene(event, "first.fxml");
        stage.setWidth(752);stage.setHeight(579);
        stage.setScene(scene);
        stage.show();
    }
